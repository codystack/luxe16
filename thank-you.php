...
<head>
    ...
    <title>Booking Confirmed :: LUXE16 STUDIOS&trade;</title>
    <meta name="description" content="At Luxe16 Studios, we believe lifestyle is an art — and we are the canvas where vision meets expression. Based in the heart of London, Luxe16 is a modern lifestyle studio that blends creativity, elegance, and culture to shape experiences that inspire.">
...
<body class="royal_preloader">
    <div id="page" class="site">
        ...
        <div class="position-relative h-100">
            <div class="container d-flex flex-wrap justify-content-center align-items-center vh-100 w-lg-50">
                <div class="col-lg-10">
                                ...
                                <div class="row g-3">
                                    <div class="col">
                                        <div class="text-center mt-20">
                                            ...
                                            <div class="mt-6">
                                                <h3 class="ot-heading__title mt-4">Booking Confirmed👏</h3>
                                                <p class="mt-3 pb-0 mb-0">Thank you for choosing Luxe16 Studio.</p>
                                                <p class="mb-3 pt-0 mt-0">You will receive a confirmation email shortly.</p>
                                                <a href="./" class="octf-btn octf-btn-primary"><i class="bi bi-arrow-left me-2"></i>Go back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
